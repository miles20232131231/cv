...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('reinvites')
        .setDescription('Releases the reinvites for everyone to join.')
    ...
    async execute(interaction) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`<:bluedot:1269054480335507510> <@${interaction.user.id}>! Has now posted the Session Reinvites! When joining Make sure to Park up until Host gets to you!
            ...
            collector.on('collect', async i => {
                try {
                    ...
                    const logEmbed = new EmbedBuilder()
                        ...
                        .setDescription(`Button clicked by <@${i.user.id}>. Session link in <#1268999009532641293>`)
                        .setFooter({
                            text: 'Centralville',
                            iconURL: 'https://cdn.discordapp.com/icons/1253924000464375868/7b1ea8a02ca4a9baec6586c648b3b1e2.png?size=4096'
                        });
